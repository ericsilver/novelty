...
minutes, currently $\sim 25\%$ through). Once it lands: rebuild
...
foreign-applicant confound on API enclaves.
\item Patent-side guild signal: for each (USPC/CPC class, ethnic
group), measure surname-concentration HHI over time. Rising HHI =
guild-like inheritance signature.
