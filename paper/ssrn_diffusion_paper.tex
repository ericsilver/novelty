...
ever been since, reversing in technology classes for marks filed 2000--2004
while the rest of the economy stays mildly positive, and back from 2008. The
swing is a technology phenomenon; outside those classes the penalty is a flat
one to four points throughout.
...
to direction, does none of this work: its quintile contrast on SEC reporting
is zero to three decimals once class, year and description length are
absorbed. Nor is the measure a proxy for patenting --- within firms the
association never reaches a tenth of a standard deviation and flips sign
between text representations.
...
equal-count bins (Figure~\ref{fig:shapes}) --- linear, quadratic, an
exponential $a + b e^{cx}$, and a
