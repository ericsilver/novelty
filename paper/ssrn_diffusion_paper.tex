...
surprising its language is against what its industry filed in the five years
before it and in the five years after. Filings whose wording the industry
subsequently moved toward are \emph{leading}; those written in language it
was already leaving behind are \emph{lagging}.

\noindent A product described in language its industry is moving toward is
less likely to still be on the market five years later than one described in
language the industry is leaving behind. Among 3.10 million registrations,
the fifth of marks with the most leading language fail the first use-proof
declaration --- the sworn statement, due between the fifth and sixth year,
that the mark is still in commercial use --- 53.3\% of the time against
51.9\% for the most lagging fifth, with class$\times$cohort fixed effects,
owner-clustered errors, and drafting and filer controls ($t = 8.3$). The
penalty is episodic rather than permanent: larger in the 1990s than it has
ever been since, absent for marks filed 2000--2004, back from 2008, and
concentrated almost entirely in technology classes.

\noindent Financial success accrues disproportionately to firms whose
language has grown less familiar to their industry, not more. Among
registered first-time filers, 0.44\% of the most lagging fifth later appear
in SEC financial-reporting records, against 0.24\% in the middle fifth and
0.39\% of the most leading fifth. How unusual the wording is, without regard
to direction, does none of this work: its association with SEC reporting is
...
\noindent Read without conditioning on grant, the same data support weaker
and sometimes opposite conclusions, because registration is itself selected
on language. And scored on individual terms rather than distributions over
themes, leading filings appear to belong to better firms --- an association
that dissolves or reverses under theme scoring, because term scoring picks
up lexical specificity rather than position. Text measures of this kind can
...
end up filing financial reports with the SEC.
...
No stable relationship exists in either direction, in either representation.
...
Filings are not independent draws. Some of them share an exact position
...
\noindent The registration profile in atypicality is decisively curved: an
...
AIC here is computed on 40 binned means, not
...
\section{What the examination funnel selects on}\label{app:registration}
