...
disagree. Term atypicality predicts both outcomes negatively ($-0.09$pp per
$\sigma$ on SEC reporting, $-0.055\sigma$ on patenting); theme atypicality
does not predict SEC reporting and predicts patenting weakly the other way
($+0.012\sigma$). The two therefore disagree in sign on both outcomes, which
