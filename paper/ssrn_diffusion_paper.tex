...
wording it was already leaving behind (\emph{lagging}). A registered US mark
must then be re-proved in commercial use between its fifth and sixth year or
be cancelled.

\noindent Leading marks are likelier to fail that test. Across 3.10 million
registrations the most leading fifth fails it 53.3\% of the time against
51.9\% for the most lagging --- 1.4 percentage points, about 2.7\% more
failure --- within class and cohort, with owner-clustered errors and drafting
and filer controls ($t = 8.3$). The gap holds across industries and across
