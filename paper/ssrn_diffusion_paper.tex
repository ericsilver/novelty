...
penalty is episodic and technological: two to three times larger for marks
filed in the late 1990s than at any time since, reversed for those filed
2000--2004, and back from 2008, with the entire swing inside four technology
classes and a flat one to four points everywhere else.

\noindent 0.83\% of first-time filers with professional representation ever
appear in SEC financial-reporting records, against 0.18\% of self-filers.
Against a gap that size the language of a filing adds little, and not where it
would be expected to. The atypicality of a firm's first registered mark does
not predict whether its owner ever reaches SEC reporting, once class, year and
description length are absorbed; the lean does, in both directions --- 0.44\%
of the most lagging fifth and 0.39\% of the most leading, against 0.24\% in
the middle fifth. Nor is any of it a proxy for patenting: within firms the
association never reaches a tenth of a standard deviation and flips sign
between text representations.

\noindent Two provisos. Scored on individual terms rather than on
distributions over themes, leading filings appear to belong to \emph{better}
firms; entered together on the same owners the two scorings carry opposite
signs and both are significant, so at most one of them is measuring position
rather than drafting style, and a change of representation is what exposes it.
And every estimate here conditions on the office having granted the mark,
because registration is itself selected on language; read without that
