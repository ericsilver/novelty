...
The refilings that do occur are where a firm could learn that unusual
language costs, and rewrite. Among the 42{,}115 abandoned applications whose
owner later registered the same mark in the same class, 74\% carry a
different goods/services description the second time. Scoring the
registered filing on the text it was first tried with, and comparing, shows
what the rewriting did. On atypicality it converged on the class: originals
in the most atypical fifth came back $0.39$ nats closer to their class's
usual language, and originals in the most conventional fifth moved $0.16$
nats away from it, while pairs that refiled the identical text moved by less
than $0.01$ at every position. Firms rewrite toward the middle --- the same
middle the examiner rewards --- from both sides, and who holds the pen does
not change the direction: owners drafting for themselves both times, owners
who hired counsel for the second attempt, and counsel rewriting their own
earlier draft all converge on the class by nearly the same amounts at every
starting position. What differs is the extent. Hiring counsel for the
refiling brings the highest rewriting rate (82\%, against 72\% when counsel
rewrites counsel) and descriptions 16\% longer; counsel rewriting counsel
shortens them by 4\%. On lead they did not: the
most leading originals came back $0.07$ less leading, but identical-text
refilings moved $0.05$ on the same cut, because a later filing date moves
both reference windows, so the genuine retreat from leading language is
about $0.02$, a sixth of a standard deviation, against half a standard
deviation of convergence on atypicality. Which text predicts the refiled
registration's gate cannot be told on 34{,}551 cases ($+0.9$pp on the
rewrite, $+0.7$pp on the original, both with standard errors near $0.8$pp).
What can be said is what these marks stamp on the estimates below: nothing.
They are $1.1$\% of the gate sample, they fail it slightly \emph{less} often
than other registrations (51.7\% against 52.8\%), and the within-class-and-year
contrast is $+2.25$pp with them and $+2.25$pp without.
