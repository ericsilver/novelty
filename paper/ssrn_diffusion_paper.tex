...
convex: about seven tenths of the top-to-bottom gap is the single step from
the fourth quintile to the fifth, seven times the average step below it, so
the penalty is a threshold rather than a gradient, and the text reports
top-versus-bottom contrasts for that reason. \emph{B:} becoming SEC-reporting, within
