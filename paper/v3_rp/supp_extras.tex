...
2004. The per-class rates are tabulated in the internet appendix section
above.
...
\subsection{Pair lead corpus-wide}

Extending the software-class pair-lead construction to every class with
sufficient volume (43 of 45; the calendar-bucket and per-filing
anchorings agree at $r = 0.983$ on identical filings and give the same
class-009 contrast): pooled within class and registration year, the
top-versus-bottom pair-lead contrast in failure at the five-year proof
is $+0.03$pp raw ($t = 0.3$) and $+0.48$pp net of the filings' own lead
and atypicality (owner-clustered $t = 4.2$, 1.30 million owner
clusters). The effect is genuinely heterogeneous: significantly positive
in 13 classes (largest in tobacco, spirits, and jewelry), significantly
negative in 3 (largest in haberdashery and advertising and retail,
$-2.1$pp), and era-unstable within both flagship classes.
Table~\ref{tab:pairleadS} carries the per-class estimates.

\begin{table}[h]\centering\footnotesize
\caption{Pair-lead contrasts at the five-year proof by class: settled
registrations, top-minus-bottom pair-lead quintile within class and
registration year, raw and net of lead and atypicality.}
\label{tab:pairleadS}
\input{results/pair_lead_corpus.tex}
\end{table}
