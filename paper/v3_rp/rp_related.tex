\section{Related literature and nomenclature}\label{sec:related}
...
$Q_{\mathrm{past}}$ and $Q_{\mathrm{future}}$ aggregate the five years of
...
\midrule
$K^{-} = \mathrm{KL}(P \| Q_{\mathrm{past}})$ & novelty \citep{Murdock2017, Barron2018}; originality \citep{HallJaffe2001} & past-facing surprise \\
$K^{+} = \mathrm{KL}(P \| Q_{\mathrm{future}})$ & transience \citep{Murdock2017}; generality \citep{HallJaffe2001}, which measures realized influence, not position & future-facing surprise \\
