...
spread of $L$ varies roughly two- to threefold across levels of $A$ under term
scoring, against 1.3- to 1.6-fold under topic scoring, because term-level
atypicality and document length are very nearly the same variable
(Appendix~\ref{app:comp} gives the like-for-like comparison). Term scoring is retained
