...
(78{,}408), is consistent in sign at $+5.6$pp. Cohorts from 2020 have no
observed proof. The pooled estimate is therefore an average over a penalty
that was not constant, and a reader who wants the penalty for a period
should read Figure~\ref{fig:cohortslopes} rather than the pooled row.
...
registration curvature on this axis is not, and Section~\ref{sec:registration}
