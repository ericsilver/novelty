...
moves lead by almost nothing: flat and decayed lead correlate at $0.982$
under themes and $0.970$ under terms, and atypicality at $1.000$ to three
decimals on both representations. The gate contrast on the decayed scoring
is within a tenth of a point of the flat one on the common sample. The
weighting is kept flat in the body because it is the simpler statement and
the decayed version changes no sign, no magnitude beyond rounding, and no
conclusion.
