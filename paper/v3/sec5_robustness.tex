...
penalty is indistinguishable from zero for the 2002--2005 cohorts and runs
$+1.8$ to $+5.6$pp for every cohort from 2008. The 2019 cohort, evaluable
only for registrations issued early enough in that year to reach seven years
inside the record, replicates at $+9.1$pp on the raw contrast. Cohorts from
...
quarter to a half under theme scoring, so a unit of lead means roughly the
same thing everywhere only in the theme representation.
