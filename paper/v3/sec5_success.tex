...
Of the 1{,}669 owners with an IPO marker, 759 have no post-debut Form D
round in the record. Their debut language leans lagging: mean lead,
standardized within class and debut year, is $-0.22$ (SE $0.04$) against
$-0.07$ (SE $0.04$) for the 910 who raised an observed round, and 29\% of
them sit in the most lagging fifth against 22\% of the funded. Both groups
are mildly atypical ($+0.13$ and $+0.15$ standard deviations). The
...
On the 2009--2018 debut ladder, funding chases the vocabulary and the
later rungs do not. AI debuts are funded at 7.8\% and blockchain debuts
at 8.0\%, against 2.8\% for internet debuts and 1.6\% for all debuts: a
first filing in AI or blockchain vocabulary is roughly five times as
likely to be followed by a priced round. At the IPO rung the gap
disappears: 0.16\% of AI debuts, 0.22\% of blockchain, and 0.21\% of
internet debuts carry an IPO marker, against 0.17\% overall, on very
small counts (1{,}896 AI debuts, 1{,}366 blockchain).
