\begin{ericbox}{new section draft --- implications for measurement ($\approx$350 words, to close the discussion)}
RP expects the paper to say what its indicator offers the field. Draft to
append to the discussion section; edit freely.

\medskip\noindent\emph{Implications for trademark-based measurement.}
...
robust to every partition, weighting, and window tried here; atypicality's
apparent effects can be artifacts of the partition (its protective effect
at the five-year proof belongs to theme importation, visible only to
global models) or of a control (its listing effect depends on how
description length is held). A study that reports ``novelty'' from
trademark text without separating the temporal from the cross-sectional
component may attribute to one what belongs to the other.
...
asset: the five-year proof of continued use is an outcome --- a dated,
sworn, product-level survival record covering every registered mark ---
that the indicator literature has largely left unused, and it is
