...
the most leading fifth are cancelled for non-use at the five-year gate 1.4
points more often than the most lagging fifth, within Nice class and
registration year with drafting and representation held ($t = 8.3$). The
penalty holds under fifty global themes, five hundred, and fifty themes fitted
per class; the protection attributed to atypical language does not, falling
from 4.4 to 0.7 points under per-class themes, because a global model reads a
theme imported from another class as atypical. The penalty was two to three
