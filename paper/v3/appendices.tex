...
theme-scored KL do not share a scale, so the comparison invited across
...
the theme vocabulary but, with no kombucha-like theme, its mass dissolves
into a generic beverages theme ($\geq 0.60$ weight at every $T$).
...
cryptocurrency/blockchain theme --- the eleven occurrences of
