...
Table~\ref{tab:constructs} maps the terms; the signed difference is written
$L$ throughout and its magnitude $|L|$.
...
filing is closer to the class's future composition than to its past one.
...
the class's filings of the five years before and the five
after.\footnote{The pair windows are calendar-year buckets rather than
per-filing days, and a window is scored only when it holds at least
2{,}000 filings.} The
...
filing's pairings. Filings in the top fifth of pair lead fail the
five-year proof of continued use $2.3$ points more often than those in the bottom fifth
($t = 8.4$, unchanged by the controls), and pair lead correlates with lead
itself at only $-0.16$. Corpus-wide the quantity does not generalize:
pooled across 43 classes it is zero raw and $+0.5$pp net of lead and
atypicality (owner-clustered $t = 4.2$), significantly positive in 13
classes and significantly negative in 3 ($-2.1$ in advertising and
retail), so being early with an arrangement of themes is a class-specific
penalty rather than a general one. The rarity of a filing's pairings, by
contrast, carries nothing once its atypicality is held ($-0.3$ points,
$t = -1.1$).
...
are established there, each appearing at least fifty times; the share is
taken over such eligible pairs only. This is recombination in the sense of the innovation
literature, novelty assembled from familiar components
\citep{Fleming2001, Uzzi2013}: familiar parts, new adjacency. Filings in
the top fifth of that share fail the five-year proof $6.1$
...
requires (Appendix~\ref{app:comp}). Five-year-proof cohorts run
