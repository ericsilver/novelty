...
def main() -> int:
    ...
    names = json.loads((RES / "per_industry_names.json").read_text()) if (RES / "per_industry_names.json").exists() else {}
    ...
    (RES / "internet_breakout.json").write_text(json.dumps(out, indent=1))
